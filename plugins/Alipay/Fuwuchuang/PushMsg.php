...
class PushMsg extends AbstractLib{
	...
	public function sendRequest($biz_content) {
		...
		return $this->getFunctionInc()->aopclient_request_execute ( $custom_send );
	}
	...
	public function pushMsgRequest($biz_content) {
		...
		return $this->getFunctionInc()->aopclient_request_execute ( $request );
	}
